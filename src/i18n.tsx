...
const messages: Record<Locale, Messages> = {
  "zh-CN": {
    ...
    builtFromYaml: "LazyCat 个人应用仓库。",
    catalogDescription:
      "这里收录可安装到 LazyCat 微服的个人应用。你可以浏览应用信息、查看版本，并下载对应的 LPK 安装包。",
    downloadLpk: "下载 LPK",
    downloadsFromReleases: "选择需要的应用，下载对应版本的 LPK 安装包。",
    docsNav: "文档",
    generatedAt: "生成时间",
    githubPagesRepository: "个人仓库",
    ...
    pending: "待生成",
    repository: "仓库",
    repositoryFooter: "LazyCat 个人仓库",
    repositoryName: "LazyCat 个人仓库",
  ...
  "en-US": {
    ...
    builtFromYaml: "LazyCat personal app repository.",
    catalogDescription:
      "Browse personal apps for LazyCat, review app details and versions, and download the matching LPK package.",
    downloadLpk: "Download LPK",
    downloadsFromReleases: "Choose an app and download the matching LPK package.",
    docsNav: "Docs",
    generatedAt: "Generated",
    githubPagesRepository: "Personal Repository",
    githubRepository: "GitHub",
    ...
    repositoryFooter: "LazyCat personal repository",
